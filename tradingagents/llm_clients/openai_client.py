...
class OpenAIClient(BaseLLMClient):
    ...
    def get_llm(self) -> Any:
        ...
        # Native OpenAI uses the Responses API. OpenAI-compatible gateways
        # are more reliable with Chat Completions unless they explicitly
        # expose the official OpenAI endpoint.
        if self.provider == "openai" and self._should_use_responses_api():
    ...
    def _should_use_responses_api(self) -> bool:
        ...
        return self.base_url.rstrip("/") in _OFFICIAL_OPENAI_BASE_URLS
